...
export type AuditType =
  ...
  | 'CREDENTIAL_CREATED' | 'CREDENTIAL_UPDATED' | 'CREDENTIAL_DELETED' | 'CREDENTIAL_USED' | 'CREDENTIAL_REVEAL'
  ...
  | 'PASSWORD_ROTATED' | 'USER_CREATED' | 'USER_UPDATED' | 'USER_DELETED' | 'ROLE_CHANGED' | 'POLICY_CHANGED'
